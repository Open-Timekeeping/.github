...
Every repository under <https://github.com/Open-Timekeeping>. Community-maintained adapter or timebase implementations hosted elsewhere are out of scope here, report those to their maintainers, but if the issue affects the OTK Protocol stack ([event-model](https://github.com/Open-Timekeeping/event-model), [wire-protocol](https://github.com/Open-Timekeeping/wire-protocol), [frame-codec](https://github.com/Open-Timekeeping/frame-codec), [transport-api](https://github.com/Open-Timekeeping/transport-api) or any `transport-*` binding) or anything in [spec/](https://github.com/Open-Timekeeping/spec), send it here too.

## What counts as a security issue

The categories that matter most for an Open Timekeeping deployment:
...
- **Denial of service** against running nodes, schema-serving endpoints, or consumer-group coordinators.
